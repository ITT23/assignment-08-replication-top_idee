...
# You can quit the application by closing the terminal
...
def read_notes():
    global notes
    with open('./assets/reader/notes.txt', encoding='utf8') as file:
        for line in file:
            line = line.strip('\n')
            notes.append(line)
...
def read_accords():
    global accords
    with open('./assets/reader/accords.txt', encoding='utf8') as file:
        for line in file:
            line = line.strip('\n')
            tokens = line.split()
            accords.append({
